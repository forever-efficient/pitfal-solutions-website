...
# ANY /api/admin/analytics → admin Lambda
resource "aws_api_gateway_method" "admin_analytics_any" {
  rest_api_id   = aws_api_gateway_rest_api.main.id
...
resource "aws_api_gateway_integration" "admin_analytics_any" {
  rest_api_id             = aws_api_gateway_rest_api.main.id
  resource_id             = aws_api_gateway_resource.admin_analytics.id
  http_method             = aws_api_gateway_method.admin_analytics_any.http_method
  integration_http_method = "POST"
  type                    = "AWS_PROXY"
  uri                     = aws_lambda_function.admin.invoke_arn
}

# OPTIONS /api/admin/analytics (CORS)
resource "aws_api_gateway_method" "admin_analytics_options" {
  rest_api_id   = aws_api_gateway_rest_api.main.id
  resource_id   = aws_api_gateway_resource.admin_analytics.id
  http_method   = "OPTIONS"
  authorization = "NONE"
...
resource "aws_api_gateway_integration" "admin_analytics_options" {
  rest_api_id = aws_api_gateway_rest_api.main.id
  resource_id = aws_api_gateway_resource.admin_analytics.id
  http_method = aws_api_gateway_method.admin_analytics_options.http_method
  type        = "MOCK"
...
resource "aws_api_gateway_method_response" "admin_analytics_options" {
  rest_api_id = aws_api_gateway_rest_api.main.id
  resource_id = aws_api_gateway_resource.admin_analytics.id
  http_method = aws_api_gateway_method.admin_analytics_options.http_method
  status_code = "200"
...
resource "aws_api_gateway_integration_response" "admin_analytics_options" {
  rest_api_id = aws_api_gateway_rest_api.main.id
  resource_id = aws_api_gateway_resource.admin_analytics.id
  http_method = aws_api_gateway_method.admin_analytics_options.http_method
  status_code = aws_api_gateway_method_response.admin_analytics_options.status_code

  depends_on = [aws_api_gateway_integration.admin_analytics_options]
...
resource "aws_api_gateway_resource" "admin_processing_jobs" {
  rest_api_id = aws_api_gateway_rest_api.main.id
  parent_id   = aws_api_gateway_resource.admin.id
  path_part   = "processing-jobs"
}

# ANY /api/admin/processing-jobs → admin Lambda
resource "aws_api_gateway_method" "admin_processing_jobs_any" {
  rest_api_id   = aws_api_gateway_rest_api.main.id
  resource_id   = aws_api_gateway_resource.admin_processing_jobs.id
  http_method   = "ANY"
  authorization = "NONE"
}

resource "aws_api_gateway_integration" "admin_processing_jobs_any" {
  rest_api_id             = aws_api_gateway_rest_api.main.id
  resource_id             = aws_api_gateway_resource.admin_processing_jobs.id
  http_method             = aws_api_gateway_method.admin_processing_jobs_any.http_method
  integration_http_method = "POST"
  type                    = "AWS_PROXY"
  uri                     = aws_lambda_function.admin.invoke_arn
}

# OPTIONS /api/admin/processing-jobs (CORS)
resource "aws_api_gateway_method" "admin_processing_jobs_options" {
  rest_api_id   = aws_api_gateway_rest_api.main.id
  resource_id   = aws_api_gateway_resource.admin_processing_jobs.id
  http_method   = "OPTIONS"
  authorization = "NONE"
...
resource "aws_api_gateway_integration" "admin_processing_jobs_options" {
  rest_api_id = aws_api_gateway_rest_api.main.id
  resource_id = aws_api_gateway_resource.admin_processing_jobs.id
  http_method = aws_api_gateway_method.admin_processing_jobs_options.http_method
  type        = "MOCK"
...
resource "aws_api_gateway_method_response" "admin_processing_jobs_options" {
  rest_api_id = aws_api_gateway_rest_api.main.id
  resource_id = aws_api_gateway_resource.admin_processing_jobs.id
  http_method = aws_api_gateway_method.admin_processing_jobs_options.http_method
  status_code = "200"
...
resource "aws_api_gateway_integration_response" "admin_processing_jobs_options" {
  rest_api_id = aws_api_gateway_rest_api.main.id
  resource_id = aws_api_gateway_resource.admin_processing_jobs.id
  http_method = aws_api_gateway_method.admin_processing_jobs_options.http_method
  status_code = aws_api_gateway_method_response.admin_processing_jobs_options.status_code

  depends_on = [aws_api_gateway_integration.admin_processing_jobs_options]
...
# /api/admin/settings
resource "aws_api_gateway_resource" "admin_settings" {
  rest_api_id = aws_api_gateway_rest_api.main.id
  parent_id   = aws_api_gateway_resource.admin.id
  path_part   = "settings"
}

# ANY /api/admin/settings → admin Lambda
resource "aws_api_gateway_method" "admin_settings_any" {
  rest_api_id   = aws_api_gateway_rest_api.main.id
  resource_id   = aws_api_gateway_resource.admin_settings.id
  http_method   = "ANY"
  authorization = "NONE"
}

resource "aws_api_gateway_integration" "admin_settings_any" {
  rest_api_id             = aws_api_gateway_rest_api.main.id
  resource_id             = aws_api_gateway_resource.admin_settings.id
  http_method             = aws_api_gateway_method.admin_settings_any.http_method
  integration_http_method = "POST"
  type                    = "AWS_PROXY"
  uri                     = aws_lambda_function.admin.invoke_arn
}

# OPTIONS /api/admin/settings (CORS)
resource "aws_api_gateway_method" "admin_settings_options" {
  rest_api_id   = aws_api_gateway_rest_api.main.id
  resource_id   = aws_api_gateway_resource.admin_settings.id
  http_method   = "OPTIONS"
  authorization = "NONE"
...
resource "aws_api_gateway_integration" "admin_settings_options" {
  rest_api_id = aws_api_gateway_rest_api.main.id
  resource_id = aws_api_gateway_resource.admin_settings.id
  http_method = aws_api_gateway_method.admin_settings_options.http_method
  type        = "MOCK"
...
resource "aws_api_gateway_method_response" "admin_settings_options" {
  rest_api_id = aws_api_gateway_rest_api.main.id
  resource_id = aws_api_gateway_resource.admin_settings.id
  http_method = aws_api_gateway_method.admin_settings_options.http_method
  status_code = "200"
...
resource "aws_api_gateway_integration_response" "admin_settings_options" {
  rest_api_id = aws_api_gateway_rest_api.main.id
  resource_id = aws_api_gateway_resource.admin_settings.id
  http_method = aws_api_gateway_method.admin_settings_options.http_method
  status_code = aws_api_gateway_method_response.admin_settings_options.status_code

  depends_on = [aws_api_gateway_integration.admin_settings_options]
...
# /api/galleries/featured/images
resource "aws_api_gateway_resource" "galleries_featured_images" {
  rest_api_id = aws_api_gateway_rest_api.main.id
  parent_id   = aws_api_gateway_resource.galleries_featured.id
  path_part   = "images"
}
resource "aws_api_gateway_method" "galleries_featured_images_any" {
  rest_api_id   = aws_api_gateway_rest_api.main.id
  resource_id   = aws_api_gateway_resource.galleries_featured_images.id
  http_method   = "ANY"
  authorization = "NONE"
}
resource "aws_api_gateway_integration" "galleries_featured_images_any" {
  rest_api_id             = aws_api_gateway_rest_api.main.id
  resource_id             = aws_api_gateway_resource.galleries_featured_images.id
  http_method             = aws_api_gateway_method.galleries_featured_images_any.http_method
  integration_http_method = "POST"
  type                    = "AWS_PROXY"
  uri                     = aws_lambda_function.admin.invoke_arn
}
resource "aws_api_gateway_method" "galleries_featured_images_options" {
  rest_api_id   = aws_api_gateway_rest_api.main.id
  resource_id   = aws_api_gateway_resource.galleries_featured_images.id
  http_method   = "OPTIONS"
  authorization = "NONE"
}
resource "aws_api_gateway_integration" "galleries_featured_images_options" {
  rest_api_id = aws_api_gateway_rest_api.main.id
  resource_id = aws_api_gateway_resource.galleries_featured_images.id
...
resource "aws_api_gateway_method_response" "galleries_featured_images_options" {
  rest_api_id = aws_api_gateway_rest_api.main.id
  resource_id = aws_api_gateway_resource.galleries_featured_images.id
  http_method = aws_api_gateway_method.galleries_featured_images_options.http_method
  status_code = "200"
...
resource "aws_api_gateway_integration_response" "galleries_featured_images_options" {
  rest_api_id = aws_api_gateway_rest_api.main.id
  resource_id = aws_api_gateway_resource.galleries_featured_images.id
  http_method = aws_api_gateway_method.galleries_featured_images_options.http_method
...
resource "aws_api_gateway_deployment" "main" {
  ...
  triggers = {
    redeployment = sha1(jsonencode([
      ...
      # Admin processing jobs
      aws_api_gateway_resource.admin_processing_jobs.id,
      aws_api_gateway_method.admin_processing_jobs_any.id,
      aws_api_gateway_integration.admin_processing_jobs_any.id,
      # Admin settings
      ...
      aws_api_gateway_resource.galleries_featured_images.id,
      aws_api_gateway_method.galleries_featured_images_any.id,
      aws_api_gateway_integration.galleries_featured_images_any.id,

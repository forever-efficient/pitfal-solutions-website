        ...
        <Container>
          <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
            {categories.map((category) => (
              ...
              >
                <div className="aspect-[4/5] bg-neutral-200 rounded-2xl overflow-hidden relative mb-4">
                  ...
                  {/* Arrow */}
                  <div className="absolute bottom-4 right-4 w-10 h-10 bg-white rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 transform group-hover:scale-100 scale-90">
                    <svg

...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPages = [
    ...
    { url: `${SITE_URL}/services/photography/`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.8 },
    { url: `${SITE_URL}/services/videography/`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.8 },
    { url: `${SITE_URL}/services/commercial-drone/`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.8 },
    { url: `${SITE_URL}/services/ai-software/`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.8 },
    { url: `${SITE_URL}/services/notary/`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.7 },
  ...
  const categoryPages = ['brands', 'portraits', 'events', 'videography', 'drone', 'ai'].map(cat => ({

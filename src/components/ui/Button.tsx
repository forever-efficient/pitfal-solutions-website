...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      // Use primary-700 for WCAG AA contrast (5.0:1 for white text)
      primary:
        'bg-primary-700 text-white hover:bg-primary-800 focus:ring-primary-500 shadow-sm hover:shadow-md',
      secondary:

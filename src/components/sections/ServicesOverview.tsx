...
const bottomRow = [
  ...
  },
  {
    ...
    icon: <StampIcon size={32} strokeWidth={1.5} />,
      ...
      <Container>
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
          ...
          <p className="text-lg text-neutral-600">
            From photography and videography to aerial imaging, AI solutions, and professional notary services —
            every project receives complete creative and technical attention.
          </p>
        </div>

        {/* Service cards — top row (2 cols) */}
        ...
        {/* Service cards — bottom row (3 cols) */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 lg:gap-2 mt-2">
